...
class MealDetialScreen extends StatelessWidget {
  ...
  final Function addRemovefavoriteMeals;
  final Function isFavoriteMeals;

  // ignore: use_key_in_widget_constructors
  const MealDetialScreen(this.addRemovefavoriteMeals, this.isFavoriteMeals);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Icon(
          isFavoriteMeals(mealId)? Icons.favorite: Icons.favorite_border,
        ),
        onPressed: ()=>addRemovefavoriteMeals(mealId),
      ),
    );
  }
}
